...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_message) {
            ...
            Intent intent = new Intent(this,add_message.class);
            startActivity(intent);
        } else if (id == R.id.view_message) {
            Toast.makeText(this, "View message", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(this,view_message.class);
            startActivity(intent);

        } else if (id == R.id.edit_message) {

            Toast.makeText(this, "Edit message", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(this,edit_message.class);
            startActivity(intent);
